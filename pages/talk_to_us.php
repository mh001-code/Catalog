...
<body>
    ...
    <div class="extra">
        <h1>Fale Conosco</h1>
        <p>Caso tenha interesse em um orçamento, dúvidas a esclarecer ou sugestões a compartilhar, estamos prontos para atendê-lo com excelência.</p>

        <h2>Entre em Contato</h2>
        <ul>
            <li><strong>WhatsApp:</strong> <a href="https://wa.link/vmq2bd" target="_blank" class="talk-us"> (62) 99312-2941</a></li>
            <li><strong>E-mail:</strong> <a href="mailto:email@gmail.com" class="talk-us">  email@gmail.com</a></li>
